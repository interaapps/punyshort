<template>
  <div>
    ...
    <div style="width: 100%; background: #141646; padding: 20px 0px;">
      ...
      <div id="features-list">
        ...
        <div>
          ...
          <h5>Statistics</h5>
          <span>Track the non-user-specific data like the date when the user visited, the browser, the estimated country and operating system.</span>
        </div>
    ...
    <a style="color: #FFFFFF; margin-left: 10px" href="/imprint">Imprint</a>
    <a style="color: #FFFFFF" href="/privacy">Privacy</a>
  </div>
</template>
<script>
export default {
